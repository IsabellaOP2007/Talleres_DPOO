...
public class SandboxConjuntos
{
    ...
    {
    	List<String> cadenas = new ArrayList<>(this.arbolCadenas);
        return cadenas;
    }
    ...
    {
    	List<String> cadena = this.getCadenasComoLista();
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	arbolCadenas.remove(minus);
    	arbolCadenas.remove(mayus);
    }
    ...
    public void volverMayusculas() {
        ...
        arbolCadenas.forEach(cadena -> nuevoConjunto.add(cadena.toUpperCase()));
