...
public class SandboxListas
{
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	...
    	for(double decimal : valores) {
    		listaEnteros.addLast((int) decimal);
    	}
    }
    ...
    public void reiniciarArregloCadenas( List<Object> objetos )
    {
    	...
    	for(Object str: objetos ) {
    		listaCadenas.addLast(str.toString());
    	}
    }
    ...
    {
    	listaEnteros.replaceAll(entero -> Math.abs(entero));
    }
    ...
    public int contarEnterosRepetidos() {
        ...
        // Contar cuántos números tienen frecuencia mayor a 1
    ...
    public void generarEnteros(int cantidad, int minimo, int maximo) {
        listaEnteros.clear(); // Vacía la lista antes de llenarla
